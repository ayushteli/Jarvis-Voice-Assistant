...
def wish():
    ...
    if hour >= 0 and hour <= 12:
        speak(f"Good Morning Aayush, It's {tt}")
        speak("I am Online Aayush, Tell me how can I help you ?")
    elif hour >= 12 and hour <= 18:
        speak(f"Good Afternoon Aayush, It's {tt}")
        speak("I am Online Aayush, Tell me how can I help you ?")
    else:
        speak(f"Good Evening Aayush, It's {tt}")
        speak("I am Online Aayush, Tell me how can I help you ?")
...
def TaskExe():
    ...
    def Music():
        ...
        if 'liggi' in musicName:
            os.startfile('E:\\Songs\\liggi.mpeg')

        elif 'barso' in musicName:
            os.startfile('E:\\Songs\\barso.mpeg')

        else:
            pywhatkit.playonyt(musicName)

        speak("Your Song Has Been Started! , Enjoy Aayush!")

    def OpenApps():
        speak("Ok Aayush , Wait A Second!")
        ...
        speak("Your Command Has Been Completed Aayush!")

    def Temp():
        search = "temperature in Lunawada"
    ...
    def Reader():
        ...
        if 'india' in name:
            ...
            os.startfile('C:\\Users\\baps\\Downloads\\A History of India.pdf')
            book = open('C:\\Users\\baps\\Downloads\\A History of India.pdf','rb')
    ...
    def screenshot():
        ...
        name1 = TakeCommand()
        name = name1 + ".png"
        path1 = "C:\\Users\\baps\\OneDrive\\Pictures\\Jarvis\\"+ name
        kk = pyautogui.screenshot()
        kk.save(path1)
        os.startfile("C:\\Users\\baps\\OneDrive\\Pictures\\Jarvis\\")
    ...
    while True:
        ...
        if 'hello' in query:
            speak("Hello Aayush , I Am Jarvis.")
            speak("Your Personal AI Assistant!")
            speak("How May I Help You?")

        elif 'how are you' in query:
            speak("I Am Fine Aayush!")
            speak("Whats About YOU?")

        elif 'you need a break' in query:
            speak("Ok Aayush , You Can Call Me Anytime !")
            speak("Just Say Wake Up Jarvis!")
            break

        elif 'youtube search' in query:
            speak("OK Aayush , This Is What I found For Your Search!")
            ...
            speak("Ok Aayush , Wait A Second!")
            webbrowser.open('https://goo.gl/maps/iZu9uTL45fNyrsEAA')
